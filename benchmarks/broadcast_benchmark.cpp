...
void add_broadcast_sizes(benchmark::Benchmark* registration) {
...
BENCHMARK(BM_AddToEachRowCurrentEndToEnd)->Apply(add_broadcast_sizes);
BENCHMARK(BM_AddToEachRowContiguousEndToEnd)->Apply(add_broadcast_sizes);
BENCHMARK(BM_AddToEachRowIndexedKernel)->Apply(add_broadcast_sizes);
BENCHMARK(BM_AddToEachRowContiguousKernel)->Apply(add_broadcast_sizes);
